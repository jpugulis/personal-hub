...
export const territories: Territory[] = [
  {
    ...
    num: "01",
    name: "Ceļojumi",
    teaser: "Travel — kalni, ekspedīcijas, kultūras, fotogrāfija",
  ...
  },
  {
    ...
    num: "04",
    name: "Snovbords",
    teaser: "Braukšana, instruktāža, kalni, ziemas dzīvesveids",
    teaserPanel: "Snowboarding — braukšana · instruktāža · ziemas dzīve",
    datumLines: ["Instruktors", "Ziemas sezonas"],
    ink: "#2E6E9E",
    heroRoute: {
  ...
  },
  {
    ...
    num: "06",
    name: "Baltais Kalns",
    teaser: "Ziema, kopiena un vietējā kalna aktivitāte",
    teaserPanel: "Ziema · kopiena · vietējā kalna dzīve",
    datumLines: ["56.82°N 24.60°E", "Ziemas bāze"],
    sample: true,
    sampleOnLine: 0,
    ink: "#4956A8",
    heroRoute: {
